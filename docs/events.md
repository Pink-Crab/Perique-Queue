...
There are 3 types of event which can be extended within your Application. These allow you to dispatch custom events to the [Event Queue](event-queue.md) to be handled by your Application.
...
As the name implies, these events are triggered as soon as possible by the [Event Queue](event-queue.md). They are not delayed nor recurring.
